...
def is_proximity(Pucks):
    ...
    def calculate_tca_and_Dtca(puck_id):
        own_puck = Pucks[own_id]
        S1 = own_puck['position']
        V1 = own_puck['velocity']
        S2 = Pucks[puck_id]['position']
    ...
    for puck_id in Pucks:
        ...
        calculate_tca_and_Dtca(puck_id)
...
# sleep: um im rythmus des servers zu bleiben
...
def calculate_avoidance_vector():
    ...
    vector = [0, 0]  # Example placeholder vector
    for puck_id, puck_data in Pucks.items():

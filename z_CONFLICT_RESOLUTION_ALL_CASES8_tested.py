...
def conflict_resolutions_and_limitations(own_id):
    ...
    for puck_id, puck_data in Pucks.items():
        ...
        # If relative_velocity is zero or the dot product is non-negative, only consider maximum resolution
...
plt.quiver(0, 0, A_0[0], A_0[1], angles='xy', scale_units='xy', scale=1, color='green', alpha=0.5, label='A_0')
plt.quiver(0, 0, A_1[0], A_1[1], angles='xy', scale_units='xy', scale=1, color='purple', alpha=0.5, label='A_1')
